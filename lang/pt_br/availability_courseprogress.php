...
$string['requires_notfinish'] = 'você não deve concluir <strong>{$a}%</strong> do curso';
$string['privacy:metadata'] = 'O plugin de restrição por progresso no curso não guarda dados pessoais.';
